 ...
 *
 */
public class StandardDatatransfer {
	private static final Logger LOG = LoggerFactory.getLogger(StandardDatatransfer.class);

	/**
	 * 构造函数
	 */
	public StandardDatatransfer() {
		
	}
	
	/**
	 * @function 读取配置文件进行初始化
	 */
	public void init() {
		try {
	...
	public static void main(String[] args) {
		StandardDatatransfer dataTransfer = new StandardDatatransfer();
		try {
			dataTransfer.init();
			//调度JOB，job参数以全局变量提供
